...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_for_one_user(self):
        '''
        ToDo list can be started and retrived later.
        '''
        ...
        # She types "Buy peackock feathers" into a textbox (Edith's hobby 
        ...
        # enters "Use peacock feathers to make a fly" (Edith is very method        ical)
        inputbox = self.browser.find_element_by_id('id_new_item')
    ...
    def test_mutiple_users_can_start_lists_at_different_urls(self):
        ...
        francis_list_url = self.webbrowser.current_url
